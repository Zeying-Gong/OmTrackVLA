...
TRAIN_DIR="$ROOT/outputs/training/next027_true_uwb_pilot_v2"
OUTPUT_ROOT="$ROOT/outputs/evaluation/next027_true_uwb_pilot_v2"

cd "$ROOT"
export CUDA_VISIBLE_DEVICES=1,2,3,4,5,6,7
export OMP_NUM_THREADS=4

for step in 128 256 384 512 640 768 896 1024; do
