...
OUTPUT_ROOT="$ROOT/outputs/evaluation/v2_014_phase3_multiscene_collection"
GPU=3
...
# One Habitat instance at a time avoids the CPU/EGL contention seen in v2_008b.
for dataset_index in 300 700; do
  for task in stt dt at; do
    run_rollout "$task" "$dataset_index"
  done
done
