#!/usr/bin/env python3
"""Controlled 64-step test of stronger safe-stop waypoint retention.
...
def effective_configuration(config, base, *, output_dir):
    ...
    require(config.get('stage') == 'recovery_sequence_safe_stop_retention_v3', 'wrong experiment stage')
