...
CONFIG="$ROOT/configs/phases/v2_013_phase3_observable_pilot.yaml"
OUTPUT="$ROOT/outputs/training/v2_013_phase3_observable_safe_stop_pilot"
LOG="$ROOT/outputs/training/v2_013_phase3_observable_safe_stop_pilot.launch.log"
EXIT_FILE="$ROOT/outputs/training/v2_013_phase3_observable_safe_stop_pilot.EXIT_CODE"
SESSION=v2_013_phase3_observable
