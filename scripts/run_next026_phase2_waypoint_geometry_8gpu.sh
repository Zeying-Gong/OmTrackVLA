...
OUTPUT_DIR="${OUTPUT_DIR:-$REPOSITORY_ROOT/outputs/training/next026_phase2_waypoint_geometry_v1}"
...
"$PYTHON_BIN" -m torch.distributed.run \
  ...
  --config configs/phases/phase2_end_to_end_v1_waypoint_geometry.yaml \
